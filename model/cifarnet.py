...
def cifarnet(
  ...
  with tf.variable_scope(scope, 'CIFARNet', [images]):
    with slim.arg_scope(
      ...
      #net = end_points['bn1'] = slim.batch_norm(net, is_training=is_training, scope='bn1')
      net = end_points['conv2'] = slim.conv2d(images, 32, [5,5], scope='conv2')
      ...
      #net = end_points['bn3'] = slim.batch_norm(net, is_training=is_training, scope='bn3')
